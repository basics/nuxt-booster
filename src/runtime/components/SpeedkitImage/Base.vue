...
export default {
  ...
  computed: {
    ...
    classNames() {
      ...
      this.resolvedLoadingSpinner &&
        classNames.push(this.resolvedLoadingSpinner.className);
      return classNames;
    },
    ...
    style() {
      return [
        this.resolvedLoadingSpinner && {
          hid: this.resolvedLoadingSpinner.className,
          type: 'text/css',
          cssText: this.resolvedLoadingSpinner.style
        },
        this.meta && {
          hid: this.className,
          type: 'text/css',
    ...
    preload() {
      ...
      return [
        new Source(this.source).getPreload(
          this.config.srcset,
          this.config.sizes,
          this.$speedkit.getCrossorigin(this.crossorigin)
        )
      ];
    }
  },
