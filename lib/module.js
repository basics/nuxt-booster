...
module.exports = function (moduleOptions) {
  ...
  // /Users/stephan.gerbeth/dev/lazy-resources/example/.nuxt                                             19:25:40
  // /_nuxt/img/critical-480.7619188.webp

  // /Users/stephan.gerbeth/dev/lazy-resources/example                                                   19:27:28
  // /_nuxt/example/assets/img/critical-480.webp

  addPlugin.bind(this)(options.fonts, this.options.alias, dir, this.options.build._publicPath)
}

function addPlugin (fonts, alias, dir, publicPath) {
  this.addPlugin({
