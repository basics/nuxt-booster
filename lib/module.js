...
function setEnvironments (nuxt, options) {
  nuxt.options.env.NUXT_SPEEDKIT_INTERSECTION_OBSERVER_ROOT_MARGIN = options.intersectionObserver.rootMargin
  nuxt.options.env.NUXT_SPEEDKIT_INTERSECTION_OBSERVER_THRESHOLD = options.intersectionObserver.threshold
}
