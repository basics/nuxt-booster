...
const { default: FontConfig } = require('./classes/FontConfig')
...
module.exports = async function (moduleOptions) {
  ...
  if (!options.ignorePerformance && this.options.ssr) {
    this.nuxt.hook('webpack:config', registerAppEntry(resolve(this.options.buildDir, pkg.name, 'entry.js')))
  } else {
  ...
  this.addPlugin({
    ...
    options: { fonts: fontConfig.toJSON() }
  })
  this.addTemplate({
