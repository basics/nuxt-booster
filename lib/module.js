...
module.exports = async function (moduleOptions) {
  ...
  this.addTemplate({
    ...
    options: { ignorePerformance: options.ignorePerformance, performance: JSON.stringify(options.performance || {}), browserSupport: JSON.stringify(getUserAgentRegExp({ browsers: pkg.browserslist }).toString()) }
  });
  this.addTemplate({
