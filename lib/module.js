...
const { addBundleRendererDirective } = requireEsm('./module/bundleRenderer');
const { registerAppEntry, autoImportComponents, preloadOptimization } = requireEsm('./module/hookFunctions');
const { default: FontConfig } = requireEsm('./classes/FontConfig');
