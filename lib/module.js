...
const { registerAppEntry, autoImportComponents, preloadOptimization, preventingGeneratedCriticalFontStyleRemove } = require('./module/hookFunctions');
...
module.exports = async function (moduleOptions) {
  ...
  preventingGeneratedCriticalFontStyleRemove(this.nuxt);
