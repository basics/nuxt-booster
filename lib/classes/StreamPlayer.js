...
async function loadLibrary () {
  const [shaka] = await Promise.all([import('@modified/shaka-player/dist/shaka-player.ui.debug'), import('@modified/shaka-player/dist/controls.css')])
