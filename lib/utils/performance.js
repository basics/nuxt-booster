...
function setupPolyfill (config = {}) {
  ...
  return {
    // connection: navigator.connection || { effectiveType: config.connection.min, saveData: config.saveData },
    ...
    // userAgent: navigator.userAgent || config.userAgent
  }
}
...
//   return connectionTypes.indexOf(polyfill.connection.effectiveType) <= connectionTypes.indexOf(customConfig.connection.min)
// }
