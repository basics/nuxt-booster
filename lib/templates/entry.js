import {run, hasSufficientPerformance, hasSufficientDownloadPerformance, setup } from 'nuxt-speedkit/utils/performance';
...
const triggerRunCallback = (success) => global.dispatchEvent(new CustomEvent('nuxt-speedkit:run', { detail: { success } }))
