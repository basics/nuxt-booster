export function addBundleRendererDirective (bundleRenderer, options) {
  ...
  bundleRenderer.directives.imagePreload = function (vnode, binding) {
    ...
    Array.isArray(binding.value) && options.images.add(binding.value)
    console.log('vnode.context.$images', vnode.context.$images)
  }
  ...
  console.log('test', bundleRenderer.directives)
}
