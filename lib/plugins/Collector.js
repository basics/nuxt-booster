...
import speedkitComponent, { MODE } from 'lazy-resources/speedkitComponent'
          ...
          .reduce((result, [key, value]) => {
            if (typeof value === 'function') {
              ...
              if (hasInitalGoodOverallConditions) {
                component = speedkitComponent(() => wrapComponent(value(), { critical: false }), MODE.VISIBLE)
              } else {
                component = speedkitComponent(() => wrapComponent(value(), { critical: false }), MODE.NONE)
              }
