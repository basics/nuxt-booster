          ...
          .reduce((result, [key, value]) => {
            if (typeof value === 'function') {
              return Object.assign(result, {
                [key]: hydrateWhenVisible(() => wrapComponent(value(), { critical: false }), { observerOptions: { rootMargin: '0px' } })
              })
            }
...
function wrapComponent (module, data = {}) {
  return module.then((component) => {
    return {
      render (h) {
        return h(component.default || component, { props: Object.assign({}, this.$attrs, data) })
      }
    }
  })
}
