...
export default {
  install (Vue) {
    Vue.mixin({
      ...
      head () {
        return {
          link: this.fontCollection.getPreloadDescriptions ? this.fontCollection.getPreloadDescriptions(this.isCritical) : [],
          style: this.fontCollection.getStyleDescriptions ? this.fontCollection.getStyleDescriptions() : [],
          noscript: this.fontCollection.getNoScriptStyleDescriptions ? this.fontCollection.getNoScriptStyleDescriptions() : [],
