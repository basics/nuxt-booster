  ...
  install (Vue) {
    Vue.mixin({
      ...
      beforeRouteEnter (to, from, next) {
        prevPageStyles = new Map(pageStyles);
        pageStyles.clear();
        next();
      },
      ...
      head () {
        ...
        style.forEach(style => pageStyles.set(style.hid, style));
        style = [].concat(Array.from(prevPageStyles.values()), Array.from(pageStyles.values()));
