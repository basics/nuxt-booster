...
Nuxt Speedkit is compatible with all current browsers.

> For backward compatibility e.g. `IE` < `Edge` polyfills  (e.g. [`picturefill`](https://www.npmjs.com/package/picturefill), [`intersection-observer`](https://www.npmjs.com/package/intersection-observer)) are needed.
