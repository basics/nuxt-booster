  ...
  asyncData () {
    return {
      ...
      stage: {
        ...
        picture: {
          sources: [
            { media: '(min-width: 1024px)', src: 'https://nuxt-speedkit.grabarzundpartner.dev/example/img/image-content-1/landscape.jpg', sizes: '1024:1024,1280:1280,1680:1680,1920:1920' },
            { src: 'https://nuxt-speedkit.grabarzundpartner.dev/example/img/image-content-1/portrait.jpg', sizes: '414,576:576,768:768' }
          ]
        }
      },
      ...
      imageTextA: {
        ...
        picture: {
          sources: [
            { media: '(min-width: 576px)', src: 'https://nuxt-speedkit.grabarzundpartner.dev/example/img/image-content-2/jpg/1920.jpg', sizes: '576:576,768:768,1024:1024,1200:1280,1600:1680,1900:1920' },
      ...
      imageTextB: {
        ...
        picture: {
          sources: [
            { media: '(min-width: 576px)', src: 'https://nuxt-speedkit.grabarzundpartner.dev/example/img/image-content-3/jpg/1920.jpg', sizes: '576:576,768:768,1024:1024,1200:1280,1600:1680,1900:1920' },
