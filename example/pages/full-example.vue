<template>
  <div class="page-full-example">
    ...
    <div class="component-image-text">
      <LazyPicture v-bind="imageTextA.picture" />
      <div
        v-font="[
          $fonts.getFont('Comic Neue', 400, 'normal'),
          $fonts.getFont('Lobster Two', 700, 'normal').addSelector('h2')]"
