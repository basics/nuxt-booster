...
The initial loading of the page can be customized with the `experimental.fallbackInit` option.

In rare cases, the initialization of the page stops and blocks if `detection.performance` is set to `true` (Default).  
