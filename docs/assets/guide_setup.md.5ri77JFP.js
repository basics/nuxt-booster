import{_ as a,o as l,c as p,k as s,a as o,t as e,R as c}from"./chunks/framework._u06EGUx.js";const g=JSON.parse('{"title":"Setup","description":"","frontmatter":{"title":"Setup"},"headers":[],"relativePath":"guide/setup.md","filePath":"guide/setup.md"}'),t={name:"guide/setup.md"},r={id:"frontmatter-title",tabindex:"-1"},E=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{$frontmatter.title}}"'},"​",-1),y=c(`<p>Check the <a href="https://nuxtjs.org/guides/configuration-glossary/configuration-modules" target="_blank" rel="noreferrer">Nuxt.js documentation</a> for more information about installing and using modules in Nuxt.js.</p><h2 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-label="Permalink to &quot;Installation&quot;">​</a></h2><p>Install <code>nuxt-speedkit</code> as a dependency to your project:</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-OxBWF" id="tab-WWb6yqc" checked="checked"><label for="tab-WWb6yqc">Yarn</label><input type="radio" name="group-OxBWF" id="tab-f8nPedR"><label for="tab-f8nPedR">NPM</label></div><div class="blocks"><div class="language-bash vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">yarn</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">add</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">nuxt-speedkit@next</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">yarn</span><span style="color:#24292E;"> </span><span style="color:#032F62;">add</span><span style="color:#24292E;"> </span><span style="color:#032F62;">nuxt-speedkit@next</span></span></code></pre></div><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">npm</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">install</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">nuxt-speedkit@next</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">npm</span><span style="color:#24292E;"> </span><span style="color:#032F62;">install</span><span style="color:#24292E;"> </span><span style="color:#032F62;">nuxt-speedkit@next</span></span></code></pre></div></div></div><p>Add <code>nuxt-speedkit</code> to the <code>modules</code> section of <code>nuxt.config.js</code>:</p><h3 id="nuxt-image" tabindex="-1">@nuxt/image <a class="header-anchor" href="#nuxt-image" aria-label="Permalink to &quot;@nuxt/image&quot;">​</a></h3><p><strong>Nuxt Speedkit</strong> uses the module <code>@nuxt/image</code>, if this is not already present, it will be integrated automatically.</p><p>It is necessary for the use of the components <code>SpeedkitYoutube</code> and <code>SpeedkitVimeo</code> to add aliases and domains to the <code>@nuxt/image</code> options. These are needed to retrieve the images from Youtube and Vimeo.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-TDQL2" id="tab-36SlKyP" checked="checked"><label for="tab-36SlKyP">@nuxt/image</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><p>See <a href="/guide/options.html">module options</a>.</p>`,13);function i(n,F,d,u,f,m){return l(),p("div",null,[s("h1",r,[o(e(n.$frontmatter.title)+" ",1),E]),y])}const B=a(t,[["render",i]]);export{g as __pageData,B as default};
